class BooksController < ApplicationController
  ...
  def correct_author
    ...
    redirect_to books_path, notice: "Not authorized To Edit or Delete This Book" if @book.nil?
  end
  ...
  private
    ...
    def book_params
      params.require(:book).permit(:title, :publication_year, :location, :author_id, :image, :citation)
    end
end
